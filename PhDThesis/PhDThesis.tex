...
\documentclass[11pt,a4paper,openright]{book} %% use when print out is also in A4
% \documentclass[12pt,a4paper,openright]{book} %% use when print-out is scaled down to B5
% \documentclass[11pt,b5paper,openright]{book} %% use when print-out is in B5
