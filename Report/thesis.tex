...
\subject{Rapport fra <x.> semesters <Bachelorprosjekt> \the\year}
\title{<Prosjektets tittel>}
\subtitle{<Emnekode>\vfill
   \includegraphics[draft,width=\textwidth]{HSN_logo_en}}
\author{<Gruppekode> \and \emph{eller} \and  <forfatter1> \and <forfatter2>}
\date{\today}
\publishers{\url{www.usn.no}\\
     Bachelor -- Master -- PhD}
